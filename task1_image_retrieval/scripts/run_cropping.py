...
def main():
    # Load configuration
    config_file = "configs/cropping_config.yaml"
    ...
    config_path = config.get("grounding_config", "configs/groundingdino_swint_ogc.yaml")
    weights_path = config.get(
        "grounding_weights", "weights/groundingdino_swint_ogc.pth"
    )
    images_dir = config.get("images_dir", "data/indonesian/images")
    cropped_dir = config.get("output_dir", "data/indonesian/cropped")
